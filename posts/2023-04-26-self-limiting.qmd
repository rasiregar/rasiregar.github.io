...
So the doctors are [resorting to using the all-versatile-but-frequently-misused-drug](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7108689/): glucocorticoids or simply, steroids. Dear laypeople who read this: it is basically Dexamethasone, Prednisone, and Methylprednisolone that you may have ingested some time in your life when you are sick. Those small pills may taste bitter on your tongue but do wonders to relieve your symptoms.
...
The use of steroids in self-limiting diseases has been nothing short of controversial. There are only a few studies that analyze the effect, and the results are inconclusive. Even a [Cochrane systematic review](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8734596/#:~:text=Steroids%20(corticosteroids)%20have%20been%20shown,symptoms%20of%20the%20common%20cold.) only study the use of intranasal steroid (the ones that you puff into your nose). While systemic steroids can effectively withdraw the symptoms, there are [many adverse effects](https://www.aafp.org/pubs/afp/issues/2020/0115/p89.html#:~:text=Physicians%20might%20assume%20that%20short,mood%20and%20sleep%20disturbance%2C%20sepsis%2C) that can come with it, like high blood sugar, high blood pressure, and even mood disturbances.
